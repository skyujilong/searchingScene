...
define(function(require, exports, module) {
	...
	var $ = require('../../../$');
	var FormItem = require('../../searchingScene/0.1/formItem');
	
	var dialogStyle = require('../../../arale/dialog/1.2.6/dialog.css'),
		Dialog = require('../../../arale/dialog/1.2.6/dialog');
	...
	var searchingForm = searchingScene.SearchingForm = new Class('SearchingForm', {
		type: undefined,
		validateAll : false,
		submitBtn: null,
		//autoSubmit: true,
